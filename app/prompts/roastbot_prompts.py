...
3. IMMUNITY: NEVER analyze or profile "AN1". You may read AN1's messages to understand how the humans are reacting, but focus STRICTLY on profiling the humans.
{BASE_RULES}
"""
